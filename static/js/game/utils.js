...
(function() {
  ...
  window.Brew.utils = {
    ...
    compareColor: function(color_a, color_b) {
      return color_a[0] === color_b[0] && color_a[2] === color_b[1] && color_a[2] === color_b[2];
    },
  ...
  window.Brew.Rectangle = (function() {
    ...
    Rectangle.prototype.equalTo = function(rect) {
      return this.left === rect.left && this.top === rect.top && this.right === rect.right && this.bottom === rect.bottom;
    };

    Rectangle.prototype.isPointInside = function(xy) {
      return xy.x > this.left && xy.x < this.right && xy.y > this.top && xy.y < this.bottom;
    };

    Rectangle.prototype.checkOverlap = function(rect) {
      var no_overlap;
      no_overlap = this.left > rect.right || this.right < rect.left || this.top > rect.bottom || this.bottom < rect.top;
      return !no_overlap;
    };

    Rectangle.prototype.checkOverlapExcludingWalls = function(rect) {
      var no_overlap;
      no_overlap = this.left >= rect.right || this.right <= rect.left || this.top >= rect.bottom || this.bottom <= rect.top;
      return !no_overlap;
    };

    Rectangle.prototype.combine = function(rect) {
    ...
    Rectangle.prototype.calcWalls = function() {
    ...
    Rectangle.prototype.getWalls = function() {
      if (this.walls.length > 0) {
        return this.walls;
      }
      return this.calcWalls();
    };

    Rectangle.prototype.getSide = function(side) {
      var x, y;
      if (side === "top") {
        return (function() {
          ...
          _results = [];
          for (x = _i = _ref = this.left, _ref1 = this.right; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; x = _ref <= _ref1 ? ++_i : --_i) {
            _results.push(new Coordinate(x, this.top));
          }
          return _results;
        }).call(this);
      } else if (side === "bottom") {
        return (function() {
          ...
          _results = [];
          for (x = _i = _ref = this.left, _ref1 = this.right; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; x = _ref <= _ref1 ? ++_i : --_i) {
            _results.push(new Coordinate(x, this.bottom));
          }
          return _results;
        }).call(this);
      } else if (side === "left") {
        return (function() {
          var _i, _ref, _ref1, _results;
          _results = [];
          for (y = _i = _ref = this.top, _ref1 = this.bottom; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; y = _ref <= _ref1 ? ++_i : --_i) {
            _results.push(new Coordinate(this.left, y));
          }
          return _results;
        }).call(this);
      } else if (side === "right") {
        return (function() {
          ...
          _results = [];
          for (y = _i = _ref = this.top, _ref1 = this.bottom; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; y = _ref <= _ref1 ? ++_i : --_i) {
            _results.push(new Coordinate(this.right, y));
          }
          return _results;
        }).call(this);
      } else {
        return console.error("invalid side named " + side);
      }
    };
