...
(function() {
  ...
  window.Brew.Item = (function(_super) {
    ...
    function Item(item_info) {
      var param, value, _ref, _ref1, _ref2;
      Item.__super__.constructor.call(this, "item");
      if (item_info.group == null) {
        console.error("bad item with no group");
      }
      this.group = item_info.group;
      this.code = Brew.group[this.group].code;
      this.bgcolor = (_ref = item_info.bgcolor) != null ? _ref : [0, 0, 0];
      this.damage = (_ref1 = item_info.damage) != null ? _ref1 : 0;
      ...
      this.flags = (_ref2 = item_info.flags) != null ? _ref2 : this.flags;
    }
  ...
  window.Brew.Inventory = (function() {
    function Inventory(max_items) {
      this.items = {};
      this.max_items = max_items != null ? max_items : Brew.config.max_inventory_items;
    ...
    Inventory.prototype.addItem = function(new_item, inv_key_override) {
      var next_key;
      if ((this.getItems().length === this.max_items) && (inv_key_override == null)) {
        return null;
      } else {
        next_key = inv_key_override != null ? inv_key_override : this.getNextKey();
  ...
  window.Brew.Monster = (function(_super) {
    ...
    function Monster(monster_info) {
      ...
      this.memory = {};
      this.pathmaps = {};
      this.sight_radius = (_ref = monster_info.sight_radius) != null ? _ref : Brew.config.default_sight_radius;
    ...
    Monster.prototype.canView = function(xy) {
      if (this.hasFlag(Brew.flags.see_all.id)) {
        return true;
      } else {
    ...
    Monster.prototype.updateKnowledgeAt = function(level, xy) {
      ...
      if ((mob != null) && !mob.hasFlag(Brew.flags.is_invisible.id)) {
  ...
  window.Brew.Level = (function() {
    function Level(depth, width, height, options) {
      ...
      this.portals = {};
      this.agents = {};
      this.ambient_light = (_ref = options != null ? options.ambient_light : void 0) != null ? _ref : [153, 153, 153];
      this.navigation = {};
    }

    Level.prototype.updateLightMap = function() {
      var changes, color, fn_allow_vision, fn_reflectivity, fn_update_light, k, key, light, light_range, lighting, lightsources, monster, old_light, overhead, prev_color, rot_fov, t, v, val, xy, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4;
      old_light = {};
      _ref = this.light;
      for (k in _ref) {
      ...
      fn_update_light = (function(_this) {
        return function(x, y, color) {
          ...
          return _this.setLightAt(xy, color);
        };
      })(this);
      ...
      for (key in _ref4) {
        ...
        if (prev_color != null) {
          ...
          if (!Brew.utils.compareColor(prev_color, color)) {
            changes.push(xy);
          }
        }
      }
      for (key in old_light) {
        if (!__hasProp.call(old_light, key)) continue;
        val = old_light[key];
        xy = keyToCoord(key);
